...
void focusup(state_t* s, passthrough_data_t data);
void focusdown(state_t* s, passthrough_data_t data);
void focusleft(state_t* s, passthrough_data_t data);
void focusright(state_t* s, passthrough_data_t data);
